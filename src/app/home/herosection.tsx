    ...
    >
      ...
      <div className="relative z-10 pt-10 px-4 grid gap-4 text-white max-w-4xl w-full text-center wrap-break-word">
        ...
        <div className="flex justify-center items-center gap-4">
          <ContactButton />
          <Link href={"tel:+13464447578"} target="_blank">
            <button className="flex items-center px-4 py-2 rounded-md border-2 border-green-500 bg-green-500 font-semibold hover:scale-95 hover:bg-transparent hover:text-green-500 transition-all ease-in-out cursor-pointer">
